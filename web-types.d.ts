...
export type NamePatternTemplate = [string | NamePatternTemplate | NamePattern, ...(string | NamePatternTemplate | NamePattern)[]];
/**
 * A reference to an element in Web-Types model.
 */
...
export interface JSONSchemaForWebTypesPreviewOfVersion20OfTheStandard {
  $schema?: string;
  /**
...
export interface HtmlContributionsHost {
  ...
  /**
   * A generic contribution, contributions list or property.
   *
   * This interface was referenced by `HtmlContributionsHost`'s JSON-Schema definition
   * via the `patternProperty` "^(?!pattern$).*$".
   */
  [k: string]: GenericHtmlContributionOrProperty | GenericHtmlContributionOrProperty[];
}
/**
...
export interface CssContributionsHost {
   ...
   * CSS pseudo-elements
   */
  'pseudo-elements'?: CssGenericItem[];
  /**
   * CSS pseudo-classes
   */
  'pseudo-classes'?: CssGenericItem[];
  /**
   * CSS functions
   */
   ...
   * via the `patternProperty` "^(?!pattern$).*$".
   */
  [k: string]: GenericCssContributionOrProperty | GenericCssContributionOrProperty[];
}
export interface JsContributionsHost {
   ...
   * via the `patternProperty` "^(?!pattern$).*$".
   */
  [k: string]: GenericJsContributionOrProperty | GenericJsContributionOrProperty[];
}
